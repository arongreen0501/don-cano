...
function dc_scripts() {
	...
	wp_enqueue_script( 'lazy_sizes', 'https://cdnjs.cloudflare.com/ajax/libs/lazysizes/4.0.1/lazysizes.min.js', '', '', false );
	...
	wp_enqueue_script( 'dc_scripts', get_template_directory_uri() . '/js/scripts-min.js', array('jquery'), '20151215', true );
